...
form_register.onsubmit = async (e) => {
    ...
    document.querySelector("#createUserForm button").innerHTML = ` <i class="fa-solid fa-user-plus me-2"></i> loading...`;
    ...
    if(!response.ok){
        ...
        document.querySelector("#createUserForm button ").innerHTML = `<i class="fa-solid fa-user-plus me-2"></i>Create User`;
        showToast(`Error creating user. Please fill all fields.`, "danger");
